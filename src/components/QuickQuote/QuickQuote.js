    ...
    <div>
        <div className='quick-quote-container'>
            ...
            <h4>The fastest way to get a estimate, is to send us some pictures of the damage, via text messaging.</h4>
              ...
              <br />
              <p>
             <b> STEP 1. </b>  Send a few pictures via text, of the damage you need repaired to <a href="sms:469-969-5119">469-969-5119.</a> Also, please include the year make and model of the vehicle.
              <br /><br />
