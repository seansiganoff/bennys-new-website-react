        ...
        <div>
          <div className='about-text-div'>
            <p>
                ...
                Using the finest materials and proven techniques, we ensure that our repairs are not only visually appealing but also durable and reliable and that is why all our work comes with a 5 year warranty!
            </p>
            <br />
          </div>         
        </div>
